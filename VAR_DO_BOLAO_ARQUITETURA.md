...
**Última atualização:** 2026-06-11 (Trava de palpite por JOGO individual [bug R. 11/06 16:25] — antes `rodada.dataFechamento`=kickoff do 1º jogo bloqueava TUDO após o 1º jogo, mesmo pros 71 restantes. Termos curtos como "placares de todos" agora viram PLACAR_JOGO em modo ambíguo que oferece os 2 caminhos: jogos da Copa + ranking do bolão. Mensagens citam ~1h10 do fim do jogo até atualizar ranking)
