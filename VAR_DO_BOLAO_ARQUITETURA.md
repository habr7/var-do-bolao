...
**Versão do documento:** 3.16.0
**Última atualização:** 2026-06-11 (Provider de placares trocado pro openfootball: corrige 5 bugs do FifaWorldCup2026Adapter [FIFA_SEASON_ID vazio em prod, instabilidade api.fifa.com, match PT vs EN sem tradução, score null virando 0×0, silêncio sem observabilidade] + ajusta mensagens de tempo do bot pra refletir latência real ~30-60min)
