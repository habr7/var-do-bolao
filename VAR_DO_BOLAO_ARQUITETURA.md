...
**Versão do documento:** 3.8.0
**Última atualização:** 2026-05-22 (visibilidade de progresso pro admin: nova intent `PROGRESSO_PALPITES` mostra quem palpitou / quem falta; nova intent `CUTUCAR_PENDENTES` (admin) manda DM identificada pros pendentes; legenda de emoji no knowledge — corrige "Mais gente registrou palpites?" e "Por que Mel tem 🍀?" da conversa Jeni 22/05)
