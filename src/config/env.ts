...
const baseSchema = z.object({
  ...
  ENABLE_BOM_DIA: z.preprocess(coerceBool, z.boolean()).default(false),
  ...
  ENABLE_RANKING: z.preprocess(coerceBool, z.boolean()).default(false),
  ...
  ENABLE_PALPITE_CALL: z.preprocess(coerceBool, z.boolean()).default(false),
  ...
  ENABLE_REMINDERS: z.preprocess(coerceBool, z.boolean()).default(false),
  ...
  ENABLE_PALPITE_REVEAL: z.preprocess(coerceBool, z.boolean()).default(false),
  ...
  ENABLE_REVISAO_DIARIA: z.preprocess(coerceBool, z.boolean()).default(true),
  ...
  ENABLE_LEMBRETE_30MIN: z.preprocess(coerceBool, z.boolean()).default(false),
