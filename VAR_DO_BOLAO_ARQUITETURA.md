...
**Versão do documento:** 3.18.0
**Última atualização:** 2026-06-11 (Anti-loop em 4 camadas — caso Lucas 11/06: WhatsApp Business "Agradeço seu contato, respondo em breve" virou loop de 8 msgs em 60s; agora detector de auto-reply + patterns AGRADECIMENTO endurecidos + cap 8 respostas/60s por waId + detector de repetida)
