...
**Versão do documento:** 3.10.0
**Última atualização:** 2026-05-22 (BUG CRÍTICO Valéria 22/05 11:23 — bot LLM mentiu "Seus palpites foram registrados" sem registrar nada; correção em 5 frentes: formato invertido `NxN Time1 x Time2`, tokenizer pra palpites concatenados sem newline, validador anti-match-ruim, pré-check anti-LLM-mentindo no smart-fallback, proibição explícita no system prompt e knowledge)
