...
- PLACAR_JOGO: pergunta sobre placar/resultado de jogo RECENTE da Copa. Ex: "qual o placar?", "quanto ta o jogo?", "quem ganhou ontem?", "como ficou o jogo do Brasil?", "ja acabou?". O bot TEM os placares no banco. Distinto de MEUS_PONTOS (pontuacao do user) e MEU_PALPITE (palpites do user).
- PONTOS_DETALHE: quanto o user pontuou em jogo/dia especifico. Ex: "quantos pontos fiz ontem?", "acertei meu palpite?", "ganhei pontos?", "pontos por jogo". Distinto de MEUS_PONTOS (total geral).
