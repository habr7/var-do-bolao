...
**Última atualização:** 2026-05-22 (paginação honesta de `PROXIMOS_JOGOS` + nova intent `MAIS_JOGOS` + cutucada inline ao completar lote — corrige bug "Todos os palpites desta rodada já estão registrados" sendo falso quando havia jogos pendentes na rodada além do top 10)
