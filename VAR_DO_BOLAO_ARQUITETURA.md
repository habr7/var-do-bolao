...
**Versão do documento:** 3.15.0
**Última atualização:** 2026-06-11 (Varredura pós-estreia: 3 bugs corrigidos [vazamento de erro técnico pro user, job atropelando sessão em andamento, mídia ignorada em silêncio] + 5 intents novas pra Copa rolando [PLACAR_JOGO, PONTOS_DETALHE, STATUS_RODADA, DESABAFO_RANKING, RECLAMACAO_BUG])
