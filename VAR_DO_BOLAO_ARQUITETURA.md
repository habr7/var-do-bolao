...
**Versão do documento:** 3.13.0
**Última atualização:** 2026-06-11 (Auditoria pré-Copa: edição TODOS estendida da v3.12.0, regras corrigidas (kickoff por jogo individual, não por rodada), BASE_CONTEXT do LLM com pontuação correta 10/7/5/3/0, send-bom-dia adaptativo "6h antes + cooldown 24h", reset de scoring quando placar é corrigido, ENABLE_* env vars, audit script cross-reference)
