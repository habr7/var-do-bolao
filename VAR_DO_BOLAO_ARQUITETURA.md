...
**Versão do documento:** 3.17.0
**Última atualização:** 2026-06-11 (3 UX/comportamento descobertos em uso real Copa rolando: PALPITE_OUTROS pra esclarecer privacidade público vs privado [Camila 11/06]; ranking sem medalhas quando todos têm 0 pts [Bolao kzados]; cap absoluto MAX_AVISOS_DIA=2 cross-job [Camila 3 msgs em 3.5h] + rodapé BRT explícito nas mensagens push + doc custo Meta API)
