...
**Versão do documento:** 3.14.0
**Última atualização:** 2026-06-11 (EMERGÊNCIA pré-Copa: pipeline incremental — antes pontos do dia 1 só sairiam dia 26 porque ninguém fechava rodada e calculate-scores filtrava status=FINALIZADA; agora processa qualquer rodada com palpites pendentes. Desempate por critérios secundários. 59 testes novos cobrindo todos os tiers + edge cases)
