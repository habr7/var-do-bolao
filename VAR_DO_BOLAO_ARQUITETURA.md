...
**Versão do documento:** 3.9.0
**Última atualização:** 2026-05-22 (onboarding leve pra novato: nova intent `DICAS_PALPITE` responde "tem dicas?/como monto?" com estratégia real do bolão; nova intent `ACOLHIMENTO_NOVATO` responde "nao entendo de futebol/to perdida/primeira vez" com tom acolhedor — corrige caso real Valéria 22/05)
