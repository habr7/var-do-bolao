...
- **v3.60.0** (2026-07-02) — **Histórico de conversas + auditoria de palpite.** Toda mensagem (entrada/saída, WhatsApp e Telegram) fica registrada pra auditoria; trilha imutável de palpites (registrou/editou/apagou/cravou) com a mensagem original como prova. Comandos de dono `#CONVERSAS`, `#CONVERSASGLOBAL` e `#AUDITORIA`. Logging fire-and-forget (nunca derruba conversa); retenção LGPD de 180d nas conversas (auditoria não expira). **1245 tests, simulador 143/143.**
