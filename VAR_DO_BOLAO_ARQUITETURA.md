...
**Versão do documento:** 3.11.0
**Última atualização:** 2026-06-11 (3 bugs corrigidos da conversa Jeni 11/06: fuso horário do display [VPS UTC mostrava 22:00 em vez de 19:00 Brasília], knowledge ambíguo sobre admin ver palpites [bot alucinou "admin vê" pra um user e "ninguém vê" pra outro], + ingestão de `squads.json` do openfootball pra responder convocações dos 48 times)
